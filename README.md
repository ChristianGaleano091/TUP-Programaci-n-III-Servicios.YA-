...
|price        | float    | Obligatorio, mayor a 0                               | Campo obligatorio / Debe ser mayor a 0                   | (float) conversión				|
|birth_date   | date     | Obligatorio, formato YYYY-MM-DD, no futura           | Campo obligatorio / Fecha inválida / No puede ser futura | DateTime					|
